 ...
 * supports the principles behind the Model-AbsView-Controller design pattern.
 *
 * MVC components in angular:
 *
 * * Model — Models are the properties of a scope; scopes are attached to the DOM where scope properties
 *   are accessed through bindings.
 * * AbsView — The template (HTML with data bindings) that is rendered into the AbsView.
 ...
 * in the AbsView without the need for a manual update.
 *
